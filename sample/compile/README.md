...
```bash
git clone git@gitee.com:hello20/NiuTrans.NMT.git
mkdir NiuTrans.NMT/build && cd NiuTrans.NMT/build
cmake -DUSE_CUDA=ON -DCUDA_TOOLKIT_ROOT_DIR='/home/huchi/work/cuda9.2/' ..
make -j
```
...
```bash
git clone https://gitee.com/hello20/NiuTrans.NMT.git
git clone https://gitee.com/huchinlp/NiuTensor.git
